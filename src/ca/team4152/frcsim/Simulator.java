...
import ca.team4152.frcsim.utils.*;
import ca.team4152.frcsim.utils.Path;
...
/*
This class runs the entire simulation.
It's kind of important.
 */
public class Simulator{

    public static final int MATCH_LENGTH = 150;
    public static final int TEAM_NONE = 0;
    public static final int TEAM_RED = 1;
    public static final int TEAM_BLUE = 2;

    private Robot robot0, robot1, robot2;
    private Plate allianceSwitch, opponentSwitch, scale;
    private List<PowerUp> powerUpQueue = new ArrayList<>();
    private PowerUp currentPowerUp = null;

    private int currentPowerUpTime;
    private int levitate, boost, force;
    private int blueAllianceMax, blueOpponentMax, blueScaleMax;
    ...
    private int matchTime, points, pointsThisRound, vaultCubes, climbers;

    public void run(double robot0Speed, double robot1Speed, double robot2Speed, List<PowerUp> powerUps,
                    List<RobotTask> robot0Tasks, List<RobotTask> robot1Tasks, List<RobotTask> robot2Tasks){
            ...
            if(currentPowerUp == null){
                try{
                    for(int i = 0; i < powerUpQueue.size(); i++){
                        PowerUp potential = powerUpQueue.get(i);
                        if(matchTime >= potential.getStartTime() && vaultCubes >= potential.getLevel()){
                            currentPowerUp = potential;
                            break;
                        }
                    }
            ...
            if(allianceSwitch.getOwner() == TEAM_RED || force == 1 || force == 3){
                ...
                if(allianceSwitch.hasOwnerChanged()){
                    ...
                    if(matchTime < 15)
                        ...
                        pointsThisRound += (1 * switchMultiplier);
                }
            }
            if(scale.getOwner() == TEAM_RED || force == 2 || force == 3){
                ...
                if(scale.hasOwnerChanged()){
                    ...
                    if(matchTime < 15)
                        ...
                        pointsThisRound += (1 * scaleMultiplier);
                }
            }
    ...
    private void setupPowerUps(List<PowerUp> powerUps){
        powerUpQueue = powerUps;
    }

    private void setupRobotTasks(List<RobotTask> robot0Tasks, List<RobotTask> robot1Tasks, List<RobotTask> robot2Tasks){
    ...
    private void createGameReport(){
        ...
        try{
            ...
            writer.write(time.toLocalDate() + " " + time.toLocalTime()); writer.newLine();
            writer.write("===================="); writer.newLine();
            writer.write("  Simulator Report"); writer.newLine();
            writer.write("===================="); writer.newLine();
            writer.newLine();

            writer.write("Points: " + points); writer.newLine();
            writer.newLine();
            writer.write("Cubes (red-blue):"); writer.newLine();
            writer.write("Alliance Switch Cubes: " + allianceSwitch.getRedCubes() + "-" + allianceSwitch.getBlueCubes()); writer.newLine();
            writer.write("Opponent Switch Cubes: " + opponentSwitch.getRedCubes() + "-" + opponentSwitch.getBlueCubes()); writer.newLine();
            writer.write("Scale Cubes: " + scale.getRedCubes() + "-" + scale.getBlueCubes()); writer.newLine();
            writer.newLine();

            writer.write("Robot #1:"); writer.newLine();
            writer.write("Moving Speed: " + robot0.getSpeed() + "ft/s"); writer.newLine();
            String tasks0 = "";
            int taskNum0 = 0;
            ...
            writer.write("Tasks: " + tasks0); writer.newLine();
            writer.write("Auto Mobility: " + robot0.completedAutoMobility()); writer.newLine();
            writer.write("Climbed: " + robot0.completedClimb()); writer.newLine();
            writer.write("Cubes Exchanged: " + robot0.getCubesExchanged()); writer.newLine();
            writer.write("Cubes Put on Alliance Switch: " + robot0.getCubesPutOnAllianceSwitch()); writer.newLine();
            writer.write("Cubes Put on Opponent Switch: " + robot0.getCubesPutOnOpponentSwitch()); writer.newLine();
            writer.write("Cubes Put on Scale: " + robot0.getCubesPutOnScale()); writer.newLine();
            writer.newLine();

            writer.write("Robot #2:"); writer.newLine();
            writer.write("Moving Speed: " + robot1.getSpeed() + "ft/s"); writer.newLine();
            String tasks1 = "";
            int taskNum1 = 0;
            ...
            writer.write("Tasks: " + tasks1); writer.newLine();
            writer.write("Auto Mobility: " + robot1.completedAutoMobility()); writer.newLine();
            writer.write("Climbed: " + robot1.completedClimb()); writer.newLine();
            writer.write("Cubes Exchanged: " + robot1.getCubesExchanged()); writer.newLine();
            writer.write("Cubes Put on Alliance Switch: " + robot1.getCubesPutOnAllianceSwitch()); writer.newLine();
            writer.write("Cubes Put on Opponent Switch: " + robot1.getCubesPutOnOpponentSwitch()); writer.newLine();
            writer.write("Cubes Put on Scale: " + robot1.getCubesPutOnScale()); writer.newLine();
            writer.newLine();

            writer.write("Robot #3:"); writer.newLine();
            writer.write("Moving Speed: " + robot2.getSpeed() + "ft/s"); writer.newLine();
            String tasks2 = "";
            int taskNum2 = 0;
            ...
            writer.write("Tasks: " + tasks2); writer.newLine();
            writer.write("Auto Mobility: " + robot2.completedAutoMobility()); writer.newLine();
            writer.write("Climbed: " + robot2.completedClimb()); writer.newLine();
            writer.write("Cubes Exchanged: " + robot2.getCubesExchanged()); writer.newLine();
            writer.write("Cubes Put on Alliance Switch: " + robot2.getCubesPutOnAllianceSwitch()); writer.newLine();
            writer.write("Cubes Put on Opponent Switch: " + robot2.getCubesPutOnOpponentSwitch()); writer.newLine();
            writer.write("Cubes Put on Scale: " + robot2.getCubesPutOnScale()); writer.newLine();
            writer.newLine();

            writer.write("====================="); writer.newLine();
            writer.write("  Game Play-by-Play"); writer.newLine();
            writer.write("====================="); writer.newLine();
            writer.write("<second>: <points that round> (<tasks completed that round>)"); writer.newLine();
